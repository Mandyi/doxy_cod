...
/*-----------------------------------------------------------*/
extern unsigned long U2RX,tick_rx4;
extern xSemaphoreHandle xGPS_RXSemaphore,xEXT_RXSemaphore;
unsigned int ClockMonitor;
...
__asm__ volatile("disi #0x3FFF"); 
	...
	#endif
	ClockMonitor++;
	if(ClockMonitor==5000)
	{
		ClockMonitor=0;
		//if(xClockMonitor_Semaphore!=NULL)
		//	xSemaphoreGiveFromISR(xClockMonitor_Semaphore,NULL);
	}	
